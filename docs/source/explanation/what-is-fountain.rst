...
It lets you write a script in any text editor and have it read as a properly
formatted screenplay, without a word processor or specialized software.
...
You write the words; the format is inferred from a small set of conventions.
...
transitions, centered text, sections and synopses for outlining, notes, and inline
emphasis.
The full syntax is defined at `fountain.io/syntax <https://fountain.io/syntax/>`_.
