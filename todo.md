...
- [x] 5.7 Open Question 10: both author and authors render; the two renderers agree
...
- [x] 6.3 B3: case-insensitive title-page guard that accepts the space form
...
- [x] 8.3 D4: emphasis delimiters stripped and spans cover only the content
